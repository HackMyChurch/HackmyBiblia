...
User.create!(email: "jacques@abf.fr", password: "00 migrat000000", nickname: "Jacques")
...
chapter = Chapter.create!(
  description: "Jésus apparaît aux disciples, en l’absence de Thomas qui dit :\n
    ...
    Au contraire il confirme : « Parce que tu m’as vu, tu crois. Heureux ceux qui ont cru sans avoir vu » (Jn 20, 28-29).",
  title: "Heureux ceux qui ont cru sans avoir vu",
  bible_ref: "Jn 20, 28-29",
)

conversation = Conversation.create!(
  name: "texte du jeudi 4 octobre",
  likes: 4,
  group_id: group.id,
